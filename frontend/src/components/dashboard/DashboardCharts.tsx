            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={qualityTrendData}>
                  ...
                  />
                  <Line type="monotone" dataKey="quality" stroke="hsl(262.1 83.3% 57.8%)" strokeWidth={3} dot={{ fill: 'hsl(262.1 83.3% 57.8%)' }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={matchDistributionData} cx="50%" cy="50%" innerRadius={60} outerRadius={80} paddingAngle={5} dataKey="value">
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={recruiterActivity}>
                ...
                />
                <Bar dataKey="value" fill="hsl(262.1 83.3% 57.8%)" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={hiringFunnelData} layout="vertical">
                ...
                />
                <Bar dataKey="count" fill="hsl(262.1 83.3% 57.8%)" radius={[0, 4, 4, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
